...
const footerLinks = [
  {
    ...
    links: [
      ...
      {
        name: "Pari Life style Wholesale",
        redirect: "#",
      },
      {
          ...
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-primary-darkBlue text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
            ...
            <div className="w-full sm:w-5/12 my-6 mx-5 sm:mx-0 flex flex-col sm:flex-row gap-2 sm:gap-0 justify-between">
              <div className="w-full sm:w-1/2">
                ...
                <p className="mt-2 leading-5">Digital Hub Bangladesh Limited,<br />
                 
                  House: 89/A, Road 8A [Old 15] <br />
                  Behind KEARI PLAZA Dhanmondi, Dhaka 1209.<br />
                  Dhaka, Bangladesh
                </p>
              </div>
...
<br />
                  Telephone: <a className="text-primary-blue" href="tel:18002029898">+880 22 222 41169</a>
                </p>
              </div>
            </div>
          ...
          <div className="px-16 py-6 w-full bg-primary-darkBlue hidden sm:flex justify-between items-center text-sm text-white">
            ...
            <span>&copy; 2000-{new Date().getFullYear()} digitalhubbd.com</span>
